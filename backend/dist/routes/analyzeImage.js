...
exports.analyzeImageRouter = (0, express_1.Router)();
...
async function extractExifMetadata(buffer) {
    try {
        const parsed = await exifr_1.default.parse(buffer, {
            gps: true,
...
async function callGroqVision(imageDataUrl) {
...
/* ── Route ── */
exports.analyzeImageRouter.post('/', upload.single('image'), async (req, res) => {
    const file = req.file;
